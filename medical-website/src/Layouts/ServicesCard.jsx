...
const ServicesCard = ({ icon, title }) => {
  return (
    <div className=" group flex flex-col items-center text-center gap-2 w-full lg:w-1/3 p-5 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg cursor-pointer lg:hover:-translate-y-6 transition duration-300 ease-in-out">
      ...
      <p>
      Experience precision and accuracy in healthcare diagnostics with our state-of-the-art laboratory tests, ensuring reliable results for informed medical decisions . "Explore our comprehensive range of advanced lab tests, conducted by skilled professionals using cutting-edge technology, delivering swift and precise insights to prioritize your well-being."
      </p>
